...
class Product(models.Model):
	...
	# 	new_resized_img = new_img.resize((200,200), Image.ANTIALIAS)
	# 	filestream = BytesIO()
	# 	new_resized_img.save(filestream, 'JPEG', quality=90)
	# 	filestream.seek(0)
...
class Cart(models.Model):
	...
	products = models.ManyToManyField(CartProduct, blank=True, related_name='related_customer')
...
class Customer(models.Model):
	...
	orders = models.ManyToManyField('Order', verbose_name='Заказы покупателя', related_name='related_cart')
